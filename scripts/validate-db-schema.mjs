...
const REQUIRED_COLUMNS = [
  ...
  [/CREATE TABLE user_credentials[\s\S]*?password_hash/m, 'user_credentials.password_hash'],
  [/CREATE TABLE user_credentials[\s\S]*?failed_attempts/m, 'user_credentials.failed_attempts'],
  [/CREATE TABLE user_credentials[\s\S]*?locked_until/m, 'user_credentials.locked_until'],
  [/CREATE TABLE user_password_invites[\s\S]*?token_hash/m, 'user_password_invites.token_hash'],
  [/CREATE TABLE user_password_invites[\s\S]*?consumed_at/m, 'user_password_invites.consumed_at'],
  ...
  [/CREATE TABLE waf_connectors[\s\S]*?poll_revision BIGINT/m, 'waf_connectors.poll_revision'],
  [/CREATE TABLE waf_connectors[\s\S]*?last_success_revision BIGINT/m, 'waf_connectors.last_success_revision'],
  [/CREATE TABLE waf_connector_snapshots[\s\S]*?poll_revision BIGINT/m, 'waf_connector_snapshots.poll_revision'],
...
const REQUIRED_INDEXES = [
  ...
  'uniq_waf_drift_events_open_asset_type',
  ...
  'idx_waf_exceptions_tenant_expires',
  'idx_waf_exceptions_tenant_asset',
...
export const TENANT_PARENT_UNIQUE_KEYS = [
  ...
  'waf_exceptions_tenant_id_id_key',
...
export const TENANT_CONSISTENT_FK_CONSTRAINTS = [
  ...
  'fk_user_credentials_user_tenant',
  'fk_user_password_invites_user_tenant',
  ...
  'fk_waf_exceptions_waf_asset_tenant',
