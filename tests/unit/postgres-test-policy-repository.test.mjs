        ...
        return {
          rows: [
            policyRow({
              ...
              timezone: params[7],
              event_trigger: params[8] == null ? null : JSON.parse(params[8]),
              state: params[9],
              enabled: params[10],
              max_concurrent_runs: params[11],
              next_run_at: params[12],
              schedule_revision: params[13],
              safety_policy_snapshot: JSON.parse(params[14]),
